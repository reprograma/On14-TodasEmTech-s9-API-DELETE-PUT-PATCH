const controller = require("../controllers/seriesControllers") //a variavel vai chamar filmes controller
...
router.get("/catalogo", controller.getSeriesAll)// a rota receber do controller o catalogo completo
// a rota receber do controller o catalogo completo
// aqui ele nao precisou mais criar filmes/:id
router.post("/criar", controller.postSeries)
